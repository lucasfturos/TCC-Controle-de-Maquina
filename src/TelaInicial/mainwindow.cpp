...
void MainWindow::configSerial() {
    ...
    connect(comunicaSerial.serial, SIGNAL(comunicaSerial.serial->readyRead()),
            this, SLOT(comunicaSeria.serialRead()));

    connect(ui->connectDevice, &QPushButton::clicked, this,
