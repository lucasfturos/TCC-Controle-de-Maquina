    ...
    while (1) {
        if (UART_Data_Ready()) { // Verifica se há dados prontos para leitura no
            ...
            if (response == MESSAGE_TYPE_LCD) {
                // Se o caractere '!' for recebido, ative o modo de comando do
                // LCD
                onDisplay = 1;
                cmdLCD = 1;
                textIndex = 0;
                ...
                // Se ';' for recebido, desative o modo de comando do LCD e
                // escreva o texto no LCD
                onDisplay = 0;
                cmdLCD = 0;
                ...
                // Se o modo de comando do LCD estiver ativado, adicione o
                // caractere ao buffer de texto
                if (textIndex < 32) {
